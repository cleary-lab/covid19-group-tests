...
parTab <- read.csv("~/Documents/GitHub/covid19-group-tests/code/viral_kinetics/pars/partab.csv",stringsAsFactors=FALSE)
#chains <- load_mcmc_chains("~/Documents/GitHub/covid19-group-tests/chains", parTab, FALSE, 1, burnin=200000,multi=TRUE)
chains <- load_mcmc_chains("~/Google Drive/nCoV/pool_samples/chains2/", parTab, FALSE, 10, burnin=100000,multi=TRUE)
